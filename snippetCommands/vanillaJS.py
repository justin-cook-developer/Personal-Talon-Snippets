...
context.keymap({
  ...
  # DOM METHODS
  'document idea em': CursorText('document.getElementById({.})'),
  'document idea': CursorText('.getElementById({.})'),
  'document class em': CursorText('document.getElementsByClassName({.})'),
  'document class': CursorText('.getElementsByClassName({.})'),
  'document query all em': CursorText('.querySelectorAll({.})'),
  'document query all': CursorText('.querySelectorAll({.})'),
  'document query em': CursorText('.querySelector({.})'),
  'document query': CursorText('.querySelector({.})'),
  'document tag em': CursorText('document.getElementsByTagName({.})'),
